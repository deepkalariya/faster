...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
         ...
         */
        public function __construct($orientation = 'P', $format = 'A4', $langue='fr', $unicode=true, $encoding='UTF-8', $marges = array(10, 10, 10, 10))
        {
         ...
         */
        public function Output($name = '', $dest = false, $fullpath = null)
        {
            ...
            return $this->pdf->Output($name, $dest, $fullpath);
        }
